            ...
            <div className={`${styleContainer.container} ${style.worksContainer}`}>
              <Title text={'Projects'}/>
                <div className={style.works}>
                    ...
                    <Work style={social} title={'Social Network'} description={'Social Network is an online platform that is used for communication, dating, as well as for entertainment and work. Users can make friends by writing a post.'}/>
                    <Work style={counter} title={'Counter'} description={'Counter is a counting device. It allows to do settings which influence on the way how the counter works.'}/>
                </div>
                </div>
            </div>
    );
